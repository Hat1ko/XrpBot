...
public class TransactionSchedulerTest {
	...
	public void shouldReturnExpectedResponseTransactionScheduler() throws IOException {
		...
		RippleAccountInfoRequest rippleAccountInfoRequest = RippleAccountInfoRequest.builder()
				.method(blockchainProperties.getMethod().getAccountInfo())
				.params(Collections.singletonList(RippleAccountInfoRequest.Param.builder()
		...
		when(rippleCommunicationService.getAccountInfo(rippleAccountInfoRequest).getResult().getAccountData()
				.getSequence()).thenReturn(TransactionSchedulerUtil.LAST_ACTUAL_ACCOUNT_SEQUENCE);
